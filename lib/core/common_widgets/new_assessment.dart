...
Future newAssessmentForm(BuildContext context, String stringToComment,
  ...
  await showDialog(
    ...
    builder: (context) => SizedBox.fromSize(
      ...
      child: AlertDialog(
        scrollable: true,
        title: Text('Choose assesstment for "$stringToComment" meeting:'),
          ...
          builder: (BuildContext context, StateSetter setState) => Column(
            ...
            children: [
                    ...
                    .map((e) => RadioListTile<ProbabilityMarks>(
                          ...
                          onChanged: (ProbabilityMarks? value) {
                            setState(() {
                              ...
                              _probability = ProbabilityNumbers[_mark] ?? 0;
              ...
              TextField(
                ...
                onChanged: (value) => _probability = int.tryParse(value) ?? 0,
                decoration:
                    const InputDecoration(label: Text('% of probability')),
              ),
              TextField(
